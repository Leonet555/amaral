...
<head>
    ...
    <title>Esqueci a senha | Vitorum</title>
...
<div class="wrap">
    <form class="card" id="forgot-form">
        ...
        <p>Informe seu e-mail cadastrado. Se existir uma conta, enviaremos um link para redefinir a senha.</p>

        <label for="email">E-mail</label>
        <input id="email" name="email" type="email" required autocomplete="email">

        <button type="submit" id="submit-btn">Enviar link</button>
        <div id="error" class="error"></div>
        <div id="ok" class="ok"></div>
        <div class="help"><a href="/login">Voltar ao login</a></div>
    </form>
</div>
